      ...
      <div className="flex flex-col items-center justify-center h-[500px] bg-[#0f0f0f] text-red-500">
        <div className="bg-[#1a1a1a] p-8 rounded-lg shadow-lg text-center">
          ...
          <p className="text-gray-400 mb-4">
            We couldn’t fetch your post. Please try again later.
          </p>
          <Link
            href="/blog"
    ...
    <section className="bg-[#0f0f0f] text-white px-6 py-16">
      <div className="max-w-6xl mx-auto text-center mb-16">
        ...
        <p className="text-gray-400 text-lg max-w-3xl mx-auto">
          Your trusted source for lifestyle inspiration, wellness wisdom, and
          travel stories that nourish the soul.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto mb-20">
        <div className="relative rounded-2xl overflow-hidden h-[500px] group">
          ...
          <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black/70 to-transparent p-6 transition-opacity duration-500 group-hover:opacity-100 opacity-90">
            ...
            <h2 className="text-3xl font-bold text-white">{heroPost.title}</h2>
            <p className="text-gray-200 text-md mt-2">{heroPost.excerpt}</p>
          ...
          {remains.map((post, i) => {
            ...
            return (
              <Link
                ...
                key={i}
                className="relative bg-[#181818] rounded-xl overflow-hidden shadow-md hover:shadow-lg transition"
              >
                ...
                <img
                  ...
                  className="w-full h-48 object-cover transition duration-500 hover:scale-105 hover:brightness-75"
                />
                <div className="p-4">
